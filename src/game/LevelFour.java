...
/**
 * Class used to initialise the fourth level of the game.
...
public class LevelFour extends GameLevel{
     ...
     * Also, it sets the finish level requirements to an integer value of 35, and starts playing the background music by initialising 'gameMusic'.
     * @param time 'Time' class instance.
     */
    public LevelFour(Time time){
        this.time=time;
        this.finishLevel=35;
        try {
            this.gameMusic = new SoundClip("data/level4.wav");
            gameMusic.loop();
    ...
    public void populate(Game game){
        ...
        Puppet puppetTwo = new Puppet(this);
        puppet.setPosition(new Vec2(-10,-10));
